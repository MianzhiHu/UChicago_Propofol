...
lv_val_hurst_everything = loadings[:, 5]
lv_val_hurst_effect_of_movie = loadings[:, 6]
...
# surrogate_generator(lv_val_hurst_everything, distance_mat_fc, 'hurst_surrogates_everything.npy')
surrogate_generator(lv_val_hurst_effect_of_movie, distance_mat_fc, 'hurst_surrogates_effect_of_movie.npy')
...
new_df_fc_rest_last_60_TR = plot_preparation(fc_lv_vals_rest_last_60_TR, fc_boot_ratio_rest_last_60_TR, fc_rest_last_60_TR_nan)
new_df_fc_movie_abs = plot_preparation(fc_lv_vals_movie_abs, fc_boot_ratio_movie_abs, fc_movie_nan)
new_df_fc_effect_of_movie = plot_preparation(fc_lv_vals_effect_of_movie, fc_boot_ratio_effect_of_movie, fc_effect_of_movie_nan)
new_df_fc_double_three_way = plot_preparation(fc_lv_vals_double_three_way, fc_boot_ratio_double_three_way, fc_double_nan)
...
new_df_edges_effect_of_movie = plot_preparation(edges_lv_vals_effect_of_movie, edges_boot_ratio_effect_of_movie, edges_effect_of_movie_nan)
new_df_edges_rest_last_60_TR = plot_preparation(edges_lv_vals_rest_last_60_TR, edges_boot_ratio_rest_last_60_TR, edges_rest_last_60_TR_nan)
new_df_edges_double_two_way = plot_preparation(edges_lv_vals_double_two_way, edges_boot_ratio_double_two_way, edges_double_nan)
new_df_edges_rest_post_hoc = plot_preparation(edges_lv_vals_rest_post_hoc, edges_boot_ratio_rest_post_hoc, edges_rest_post_hoc_nan)
